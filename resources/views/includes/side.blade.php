        ...
        <div class="row">
            <div class="wrapper">
                <div class=" rtl-side-bar  side-bar hidden-xs">
                    <ul>
                        <li class="menu-head"><a href="/"> دكتور عبود </a><a href="#" class="push_menu"><span class="fa fa-fw fas fa-bars pull-right"></span></a>
                        </li>
                        <div class="menu">
                            ...
                            <li><a  href="{{route('orders.index')}}">سجل الطلبات<span class="fa fa-fw fas fa-file-alt pull-right"></span></a></li>
